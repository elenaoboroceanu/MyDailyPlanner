...
namespace DailyPlanner.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<DailyPlannerDbContext>
    {
        ...
        protected override void Seed(DailyPlannerDbContext context)
        {
            ...
            var toilet = new Flashcard() {Name = "Toilet", Description = "Toilet", Type = bathroom, Image = null};
            var shower = new Flashcard() {Name = "Shower", Description = "Shower", Type = bathroom, Image = null};
            ...
            var mirror = new Flashcard() {Name = "Mirror", Description = "Mirror", Type = bathroom, Image = null};
            var sink = new Flashcard() {Name = "Sink", Description = "Sink", Type = bathroom, Image = null};
            var tap = new Flashcard() {Name = "Tap", Description = "Tap", Type = bathroom, Image = null};
            var towel = new Flashcard() {Name = "Towel", Description = "Towel", Type = bathroom, Image = null};
            var bath = new Flashcard() {Name = "Bath", Description = "Bath", Type = bathroom, Image = null};
            ...
            var soap = new Flashcard() {Name = "Soap", Description = "Soap", Type = bathroom, Image = null};
            ...
            var playDough = new Toy {Name = "Play dough", Description = "Dough to play", ToyType = personalToy};
            var riceInCups = new Toy {Name = "Rice in cups", ToyType = personalToy};
            ...
            context.Toys.AddOrUpdate(
                ...
                ringsOnSticks,
                riceInCups,
                new Toy {Name = "HT:Bowling", Description = "Bowling set from HT", ToyType = homeTeacherToy},
                carsOnWhireToy,
                new Toy
                {
                ...
                new Toy {Name = "Shape match: geometrical shapes on wooden table", ToyType = personalToy}
                );
